<section id="showcase">
    <div class="container-fluid right-position">
        ...
        <div class="row gradient-bg">
            <div class="col-lg-12">
                <div class="text-center showcase-text section-header">
                    <div>
        ...
        <div class="row justify-content-center showcase-area">
            <div class="pr-0 col-lg-12 col-md-12 col-xs-12">
                <div class="showcase-slider owl-carousel">
                    ...
                    <div class="item">
                        <div class="screenshot-thumb">
                            <img src="/assets/landing/img/showcase/03.jpg" class="img-fluid" alt="" />
                            <div class="text-center hover-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="single-text">
                    ...
                    <div class="item">
                        <div class="screenshot-thumb">
                            <img src="/assets/landing/img/showcase/04.jpg" class="img-fluid" alt="" />
                            <div class="text-center hover-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="single-text">
                    ...
                    <div class="item">
                        <div class="screenshot-thumb">
                            <img src="/assets/landing/img/showcase/05.jpg" class="img-fluid" alt="" />
                            <div class="text-center hover-content">
                                <div class="fancy-table">
                                    <div class="table-cell">
                                        <div class="single-text">
